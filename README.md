...
*(Generated by `src/evaluate.py` after training.)*

---

## W&B Run

[View training run on Weights & Biases](https://wandb.ai/YOUR_ENTITY/intel-image-classification)

*(Replace with your actual run URL after training.)*
